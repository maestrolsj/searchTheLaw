...
public class SlideMenuLib extends Drawable {
  ...
  /** Draws a line between two {@link SlideMenuLib.JoinedPath}s at distance {@code parameter} along each path. */
  ...
  /** Paths were generated with at this size for {@link SlideMenuLib#PATH_GEN_DENSITY}. */
  ...
  public SlideMenuLib(Resources resources) {
    this(resources, false);
  }

  public SlideMenuLib(Resources resources, boolean rounded) {
   ...
   * {@link SlideMenuLib#PATH_GEN_DENSITY}, no scaling needs to be done.
   */
